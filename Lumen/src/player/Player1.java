...
public class Player1 {
	...
	public static void draw() {
		if (me) {
			...
			singleplayer.server.sendGet("http://" + server.address + "/index.php?field0=SET&&field1=player1.x&&field2=" + x);
			singleplayer.server.sendGet("http://" + server.address + "/index.php?field0=SET&&field1=player1.y&&field2=" + y);
			if (direction == dir.back) singleplayer.server.sendGet("http://" + server.address + "/index.php?field0=SET&&field1=player1.direction&&field2=" + 0);
			if (direction == dir.front) singleplayer.server.sendGet("http://" + server.address + "/index.php?field0=SET&&field1=player1.direction&&field2=" + 1);
			if (direction == dir.left) singleplayer.server.sendGet("http://" + server.address + "/index.php?field0=SET&&field1=player1.direction&&field2=" + 2);
			if (direction == dir.right) singleplayer.server.sendGet("http://" + server.address + "/index.php?field0=SET&&field1=player1.direction&&field2=" + 3);
		} else {
			x =  Float.parseFloat(singleplayer.server.sendGet("http://" + server.address + "/index.php?field0=GET&&field1=player1.x"));
			y =  Float.parseFloat(singleplayer.server.sendGet("http://" + server.address + "/index.php?field0=GET&&field1=player1.y"));
			
			String sync_direction = singleplayer.server.sendGet("http://" + server.address + "/index.php?field0=GET&&field1=player1.direction");
